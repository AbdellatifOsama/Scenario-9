...
{
    /// <inheritdoc />
    public partial class CheckoutMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carts", x => new { x.BookEntityId, x.ApplicationUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    VisaCardNumber = table.Column<long>(type: "bigint", nullable: false),
                    VisaCVV = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisaExpireDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
